...
Quick select is an efficient algorithm for finding the k-th item in a list. The following is a simple implemenation to find the k-th smallest item from a list of integers.
...
/// wihtout allocating any new memory
///
